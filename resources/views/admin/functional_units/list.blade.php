            ...
            <div class="accordion-collapse collapse {{ app('request')->input('functional_units') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('functional_units') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdFunctionalUnits_campo" class="form-group">
                                    ...
                                    <input type="number" min="1" id="IdFunctionalUnits" name="IdFunctionalUnits" class="form-control" value="{{ app('request')->input('IdFunctionalUnits') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="functional_units" class="form-control" value="foo"/>
