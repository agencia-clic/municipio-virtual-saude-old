...
<div class="row mt-1">
    <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
        <div id="title_materials_filter_fields" class="form-group">
            ...
            <input type="text" id="title_materials_filter" name="title_materials_filter" class="form-control" oninput="this.value = this.value.toUpperCase()">
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="IdMaterials_fields" class="form-group">
            ...
            <select id="IdMaterials" name="IdMaterials" class="form-control @error('IdMaterials') is-invalid @enderror" url-query="{{ route('materials.json') }}">
...
<div class="row mt-1">
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="amount_fields" class="form-group">
            ...
            <input type="text" id="amount" name="amount" class="form-control @error('amount') is-invalid @enderror" value="{{ $emergency_services_materials->amount ?? "0" }}" required>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div id="note_fields" class="form-group">
            ...
            <textarea class="form-control @error('note') is-invalid @enderror" id="note" name="note" rows="3" required>{{old('note') ?? $emergency_services_materials->note ?? ""}}</textarea>
