...
<div class="mt-3 mb-3">
    ...
    <span class="badge rounded-pill badge-soft-primary">{{ $flowcharts['count'] }} de {{ $flowcharts['data']->total() }} registros</span>
</div>
                ...
                <div class="row flex-between-center">
                    <div class="col-sm-auto mb-2 mb-sm-0">
                        <div class="btn-group btn-group-sm" role="group" aria-label="...">
                            <button class="btn btn-primary" type="button" data-redirect="{{ route('flowcharts.form') }}"><span class="fas fa-plus"></span></button>
                            ...
                            <button class="btn btn-primary collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('flowcharts.form') }}"><span class="fas fa-times"></span></button>
                        </div>
                    </div>
