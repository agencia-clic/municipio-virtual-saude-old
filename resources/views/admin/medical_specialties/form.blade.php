...
<div class="mt-3 mb-3">
    <span class="h5 text-800">Especialidade</span>
</div>
                ...
                <div class="row flex-between-center">
                    <div class="col-sm-auto mb-2 mb-sm-0">
                        <div class="btn-group btn-group-sm" role="group" aria-label="...">
                            <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('medical_specialties') }}"><span class="fas fa-arrow-left"></span></button>
