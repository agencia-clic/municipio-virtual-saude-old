...
<div class="row">
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="code_fields" class="form-group">
            ...
            <input type="text" id="code" name="code" class="form-control @error('code') is-invalid @enderror" value="{{old('code') ?? $rooms_beds->code ?? ""}}">
            <div class="valid-feedback">sucesso!</div>
        </div>
    </div>
...
<div class="row mt-1">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div id="note_fields" class="form-group">
            ...
            <textarea class="form-control @error('note') is-invalid @enderror" id="note" name="note" rows="3" required>{{old('note') ?? $rooms_beds->note ?? ""}}</textarea>
            <div class="valid-feedback">sucesso!</div>
        </div>
    </div>
</div>