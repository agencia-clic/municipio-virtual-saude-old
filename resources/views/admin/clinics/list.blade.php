...
<!-- actions - start -->
<div class="mt-3 mb-3">
    <span class="h4 text-800">Clínicas</span>
    <span class="badge rounded-pill badge-soft-primary">{{ $clinics['count'] }} de {{ $clinics['data']->total() }} registros</span>
</div>
            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        <button class="btn btn-primary" type="button" data-redirect="{{ route('clinics.form') }}"><span class="fas fa-plus"></span></button>
                        ...
                        <button class="btn btn-primary collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('clinics') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
...
<div class="card mb-3" id="customersTable" data-list=''>
            ...
            <div class="accordion-collapse collapse {{ app('request')->input('clinics') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('clinics') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdClinics_campo" class="form-group">
                                    ...
                                    <input type="number" min="1" id="IdClinics" name="IdClinics" class="form-control" value="{{ app('request')->input('IdClinics') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="clinics" class="form-control" value="foo"/>
    ...
    <div class="card-body p-0">
        <div class="table-responsive scrollbar">
            <table class="table table-sm table-striped fs--1 mb-0 overflow-hidden">
                ...
                @if(!empty($clinics['data']->total()) AND ($clinics['data']->total() > 0))
    ...
    <!-- paginations -- start -->
    {{ $clinics['data']->appends(app('request')->all())->links() }}
