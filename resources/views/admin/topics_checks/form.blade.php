...
<div class="row">
    <div class="col-sm-12 col-md-6 col-lg-6 col-xl-6">
        <div id="title_fields" class="form-group">
            ...
            <input type="text" id="title" name="title" class="form-control form-control-sm @error('title') is-invalid @enderror" value="{{old('title') ?? $topics_checks->title ?? ""}}" required>
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="classification_fields" class="form-group">
            ...
            <select name="classification" class="form-control form-control-sm @error('classification') is-invalid @enderror">
