            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('call_panel.form') }}"><span class="fas fa-plus"></span></button>
                        ...
                        <button class="btn btn-primary btn-sm collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('call_panel') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
...
<div class="card mb-3" id="customersTable" data-list=''>
    ...
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Painel de Chamada</h5>
            </div>
        </div>
    </div>
    ...
    <div class="accordion" id="accordionExample">
        <div class="accordion-item">
            <div class="accordion-collapse collapse {{ app('request')->input('call_panel') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">

                    <form id="formFiltro" action="{{ route('call_panel') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdCallPanel_campo" class="form-group">
                                    <label for="IdCallPanel" id="label_IdCallPanel">Código:</label>
                                    <input type="number" min="1" id="IdCallPanel" name="IdCallPanel" class="form-control form-control-sm" value="{{ app('request')->input('IdCallPanel') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="call_panel" class="form-control form-control-sm" value="foo"/>
                                ...
                                <td class="border name white-space-nowrap py-2">
                                    <div class="d-flex d-flex align-items-center">
                                        <div class="avatar avatar-xl me-2">
                                            <div class="avatar-name rounded-circle" title="código"><span>{{ $val->IdCallPanel }}</span></div>
                                        </div>
                                    </div>
                                </td>
                                    ...
                                    <div class="dropdown font-sans-serif position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-2">
                                            <div class="bg-white py-2">
                                                ...
                                                @can('roles', ['call_panel.update'])
                                                <!-- edit -->
                                                <a class="dropdown-item fw-bold" href="{{route('call_panel.form', ['IdCallPanel' => base64_encode($val->IdCallPanel)])}}"><span class="fas fa-edit me-1"></span><span> Editar</span></a>
                                                <div class="dropdown-divider"></div>
                                                @endcan

                                                @can('roles', ['call_panel.delete'])
                                                <!-- delete -->
                                                <a class="dropdown-item fw-bold" href="{{route('call_panel.form.delete', ['IdCallPanel' => base64_encode($val->IdCallPanel)])}}" data-id="{{ $val->IdCallPanel }}" action="delete"><span class="fas fa-trash-alt me-1"></span><span> Deletar</span></a>
                                                @endcan
                                            </div>
                                        </div>
                                    </div>
