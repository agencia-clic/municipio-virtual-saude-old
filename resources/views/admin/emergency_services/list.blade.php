...
<!-- actions - start -->
<div class="mt-3 mb-3">
    <span class="h5 text-800">Recepção</span>
            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        ...
                        <button class="btn btn-primary btn-sm collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('emergency_services') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
