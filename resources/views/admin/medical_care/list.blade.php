            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        ...
                        <button class="btn btn-primary collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('medical_care', ['IdFlowcharts' => $IdFlowcharts]) }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
            ...
            <div class="accordion-collapse collapse {{ app('request')->input('medical_care') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('medical_care', ['IdFlowcharts' => $IdFlowcharts]) }}" method="get" enctype="multipart/form-data">
                            ...
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="types_campo" class="form-group">
                                    ...
                                    <select name="types" id="types" class="form-control">
                                        <option value="atem" {{ app('request')->input('types') == "atem" ? "selected" : ""}}>Atendimentos</option>
                                        <option value="atem-s" {{ app('request')->input('types') == "atem-s" ? "selected" : ""}}>Em Atendimento</option>
                                    </select>
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="medical_care" class="form-control" value="foo"/>
...
<!-- scripts -->
@section('scripts')
<script src="{{ asset('admin/js/modules/medical_care-list.js') }}"></script>
