            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('users.form', ['module' => app('request')->input('module')]) }}"><span class="fas fa-plus"></span></button>
                        ...
                        <button class="btn btn-primary btn-sm collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('users') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
                ...
                @if(!empty($users['data']->total()) AND ($users['data']->total() > 0))
                    <thead class="bg-200 text-900">
                        <tr>
                            ...
                            <th class="sort pe-1 white-space-nowrap text-center">Name Mãe</th>
                            <th class="sort pe-1 white-space-nowrap text-center" width="10%">CPF</th>
                                    ...
                                    <div class="dropdown font-sans-serif position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-2">
                                            <div class="bg-white py-2">
                                                <!-- edit -->
                                                <button class="dropdown-item fw-bold" type="button" title="Mesclar Pacientes" iframe-form="{{ route('users_patients.merger', ['IdUsers' => base64_encode($val->IdUsers)]) }}" iframe-create="{{ route('users_patients.merger.create', ['IdUsers' => base64_encode($val->IdUsers)]) }}"><span class="fas fa-users-cog me-2"></span> Mesclar</button>
                                            </div>
                                        </div>
                                    </div>
                                </td>
