            ...
            <div class="accordion-collapse collapse {{ app('request')->input('medication_administrations') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('medication_administrations') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdMedicationAdministrations_campo" class="form-group">
                                    ...
                                    <input type="number" min="1" id="IdMedicationAdministrations" name="IdMedicationAdministrations" class="form-control" value="{{ app('request')->input('IdMedicationAdministrations') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="medication_administrations" class="form-control" value="foo"/>
