            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('materials.form') }}"><span class="fas fa-plus"></span></button>
                        ...
                        <button class="btn btn-primary btn-sm collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('materials') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
            ...
            <div class="accordion-collapse collapse {{ app('request')->input('materials') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('materials') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdMaterials_campo" class="form-group">
                                    ...
                                    <input type="number" min="1" id="IdMaterials" name="IdMaterials" class="form-control form-control-sm" value="{{ app('request')->input('IdMaterials') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="materials" class="form-control form-control-sm" value="foo"/>
