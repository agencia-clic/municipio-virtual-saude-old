...
<div class="row">
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="IdMedicationPrescription_fields" class="form-group">
            ...
            <select id="IdMedicationPrescription" name="IdMedicationPrescription" class="form-control form-control-sm @error('IdMedicationPrescription') is-invalid @enderror" url-query="{{ route('medication_prescription') }}">
...
<div class="row mt-1">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div id="amount_fields" class="form-group">
            ...
            <input type="number" id="amount" name="amount" class="form-control form-control-sm @error('amount') is-invalid @enderror" value="{{old('amount') ?? $emergency_services_forward->amount ?? ""}}" required>
...
<div class="row mt-1">
    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
        <div id="title_medication_units_filter_fields" class="form-group">
            ...
            <input type="text" id="title_medication_units_filter" name="title_medication_units_filter" class="form-control form-control-sm" oninput="this.value = this.value.toUpperCase()">
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="IdMedicationUnits_fields" class="form-group">
            ...
            <select id="IdMedicationUnits" name="IdMedicationUnits" class="form-control form-control-sm @error('IdMedicationUnits') is-invalid @enderror" url-query="{{ route('medication_units.json') }}">
...
<div class="row mt-1">
    ...
    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
        <div id="title_medication_administrations_filter_fields" class="form-group">
            ...
            <input type="text" id="title_medication_administrations_filter" name="title_medication_administrations_filter" class="form-control form-control-sm" oninput="this.value = this.value.toUpperCase()">
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="IdMedicationAdministrations_fields" class="form-group">
            ...
            <select id="IdMedicationAdministrations" name="IdMedicationAdministrations" class="form-control form-control-sm @error('IdMedicationAdministrations') is-invalid @enderror" url-query="{{ route('medication_administration.json') }}">
...
<div class="row mt-1">
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="type_medication_fields" class="form-group">
            ...
            <select name="type_medication" class="form-control form-control-sm @error('type_medication') is-invalid @enderror">
...
<div class="row mt-1">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div id="note_prescription_fields" class="form-group">
            ...
            <textarea class="form-control form-control-sm @error('note_prescription') is-invalid @enderror" id="note_prescription" name="note_prescription" rows="3">{{ $emergency_services_forward->note ?? "" }}</textarea>
            <div class="valid-feedback">sucesso!</div>
        </div>
    </div>
</div>
