<input type="hidden" id="IdUsersResponsibleInternment" name="IdUsersResponsibleInternment" class="form-control" value="{{ auth()->user()->IdUsers }}">
        ...
        <div class="row mt-2">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div id="main_signs_fields" class="form-group">
                    ...
                    <textarea class="form-control @error('main_signs') is-invalid @enderror" id="main_signs" name="main_signs" rows="4" required>{{$emergency_services_conducts->main_signs ?? ""}}</textarea>
        ...
        <div class="row mt-2">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div id="justify_hospitalization_fields" class="form-group">
                    ...
                    <textarea class="form-control @error('justify_hospitalization') is-invalid @enderror" id="justify_hospitalization" name="justify_hospitalization" rows="4" required>{{$emergency_services_conducts->justify_hospitalization ?? ""}}</textarea>
                    <div class="valid-feedback">sucesso!</div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-2">
            <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                <div id="main_results_fields" class="form-group">
                    ...
                    <textarea class="form-control @error('main_results') is-invalid @enderror" id="main_results" name="main_results" rows="4">{{$emergency_services_conducts->main_results ?? ""}}</textarea>
                    <div class="valid-feedback">sucesso!</div>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-1">
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <div id="code_main_filter_fields" class="form-group">
                    ...
                    <input type="text" id="code_main_filter" name="code_main_filter" class="form-control" oninput="this.value = this.value.toUpperCase()">
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                ...
                <div class="input-group mb-2">
                    <input type="text" id="cid10_main_filter" name="cid10_main_filter" class="form-control" oninput="this.value = this.value.toUpperCase()">
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md col-lg col-xl">
                <div id="IdCid10Main_fields" class="form-group">
                    ...
                    <select id="IdCid10Main" name="IdCid10Main" class="form-control @error('IdCid10Main') is-invalid @enderror" url-query="{{ route('cid10.form.json') }}">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <div id="code_secondary_filter_fields" class="form-group">
                    ...
                    <input type="text" id="code_secondary_filter" name="code_secondary_filter" class="form-control" oninput="this.value = this.value.toUpperCase()">
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                ...
                <div class="input-group mb-2">
                    <input type="text" id="cid10_secondary_filter" name="cid10_secondary_filter" class="form-control" oninput="this.value = this.value.toUpperCase()">
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md col-lg col-xl">
                <div id="IdCid10Secondary_fields" class="form-group">
                    ...
                    <select id="IdCid10Secondary" name="IdCid10Secondary" class="form-control @error('IdCid10Secondary') is-invalid @enderror" url-query="{{ route('cid10.form.json') }}">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
                <div id="code_associated_causes_filter_fields" class="form-group">
                    ...
                    <input type="text" id="code_associated_causes_filter" name="code_associated_causes_filter" class="form-control" oninput="this.value = this.value.toUpperCase()">
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-3 col-lg-3 col-xl-">
                ...
                <div class="input-group mb-2">
                    <input type="text" id="cid10_associated_causes_filter" name="cid10_associated_causes_filter" class="form-control" oninput="this.value = this.value.toUpperCase()">
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md col-lg col-xl">
                <div id="IdCid10AssociatedCauses_fields" class="form-group">
                    ...
                    <select id="IdCid10AssociatedCauses" name="IdCid10AssociatedCauses" class="form-control @error('IdCid10AssociatedCauses') is-invalid @enderror" url-query="{{ route('cid10.form.json') }}">
    ...
    <div class="card-body bg-light">
        ...
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div id="insurance_cnpj_fields" class="form-group">
                    ...
                    <input type="text" id="insurance_cnpj" name="insurance_cnpj" class="form-control" value="{{ old('insurance_cnpj') ?? $emergency_services_conducts->insurance_cnpj ?? "" }}">
                    <div class="valid-feedback">sucesso!</div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div id="no_ticket_fields" class="form-group">
                    ...
                    <input type="text" id="no_ticket" name="no_ticket" class="form-control" value="{{ old('no_ticket') ?? $emergency_services_conducts->no_ticket ?? "" }}">
                    <div class="valid-feedback">sucesso!</div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div id="serie_fields" class="form-group">
                    ...
                    <input type="text" id="serie" name="serie" class="form-control" value="{{ old('serie') ?? $emergency_services_conducts->serie ?? "" }}">
                    <div class="valid-feedback">sucesso!</div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div id="insurance_company_cnpj_fields" class="form-group">
                    ...
                    <input type="text" id="insurance_company_cnpj" name="insurance_company_cnpj" class="form-control" value="{{ old('insurance_company_cnpj') ?? $emergency_services_conducts->insurance_company_cnpj ?? "" }}">
                    <div class="valid-feedback">sucesso!</div>
                </div>
            </div>
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div id="cbor_fields" class="form-group">
                    ...
                    <input type="text" id="cbor" name="cbor" class="form-control" value="{{ old('cbor') ?? $emergency_services_conducts->cbor ?? "" }}">
                    <div class="valid-feedback">sucesso!</div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
                <div id="cnae_company_fields" class="form-group">
                    ...
                    <input type="text" id="cnae_company" name="cnae_company" class="form-control" value="{{ old('cnae_company') ?? $emergency_services_conducts->cnae_company ?? "" }}">
                    <div class="valid-feedback">sucesso!</div>
                </div>
            </div>
        ...
        <div class="col-sm-12 col-md col-lg col-xl">
            <div id="description_nature_njury_fields" class="form-group">
                ...
                <select name="description_nature_njury" class="form-control @error('description_nature_njury') is-invalid @enderror">
                    <option value="">...</option>
