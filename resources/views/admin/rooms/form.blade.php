...
<div class="mt-3 mb-3">
    <span class="h5 text-800">Quarto</span>
</div>
                ...
                <div class="row flex-between-center">
                    <div class="col-sm-auto mb-2 mb-sm-0">
                        <div class="btn-group btn-group-sm" role="group" aria-label="...">
                            <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('rooms') }}"><span class="fas fa-arrow-left"></span></button>
    ...
    <div class="card mb-3 {{$rooms && $rooms->IdRooms ? "" : "hide"}}">
        ...
        <div class="card-body bg-light">
            ...
            <div class="col-12 mt-2">
                 <button class="btn btn-primary btn-sm btn-sm" type="Leitos" iframe-form="{{ route('rooms_beds.form', ['IdRooms' => base64_encode($rooms->IdRooms)]) }}" iframe-create="{{ route('rooms_beds.form.create', ['IdRooms' => base64_encode($rooms->IdRooms)]) }}">Inserir</button>
            </div>
        </div>
    </div>
    @endif
