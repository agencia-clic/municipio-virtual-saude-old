            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        <button class="btn btn-primary" type="button" data-redirect="{{ route('rooms.form') }}"><span class="fas fa-plus"></span></button>
                        ...
                        <button class="btn btn-primary collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('rooms') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
