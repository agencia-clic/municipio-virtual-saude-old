...
<div class="mt-3 mb-3">
    ...
    <span class="badge bg-primary">
        @if ($cid10->firstItem())
            ...
            {!! __('até') !!}
            <span class="font-medium">{{ $cid10->lastItem() }}</span>
        @else
            {{ $cid10->count() }}
        @endif
        {!! __('de') !!}
        <span class="font-medium">{{ $cid10->total() }}</span>
        {!! __('registros') !!}
    </span>
</div>
            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('cid10.form') }}"><span class="fas fa-plus"></span></button>
                        ...
                        <button class="btn btn-primary btn-sm collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('cid10') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
...
<div class="card mb-3" id="customersTable" data-list=''>
    ...
    <div class="card-body p-0">
        <div class="table-responsive scrollbar">
            <table class="table table-sm table-striped fs--1 border mb-0 overflow-hidden">
                ...
                @if(!empty($cid10->total()) AND ($cid10->total() > 0))
    ...
    <!-- paginations -- start -->
    {{ $cid10->appends(app('request')->all())->links() }}
