...
<div class="row">
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="type_allergies_fields" class="form-group">
            ...
            <select name="type_allergies" id="type_allergies" class="form-control @error('type_allergies') is-invalid @enderror" required>
...
<div class="row mt-1 hide medication_prescriptions-allergies">
    <div class="col-sm-12 col-md-3 col-lg-3 col-xl-3">
        <div id="title_medication_prescriptions_filter_fields" class="form-group">
            ...
            <input type="text" id="title_medication_prescriptions_filter" name="title_medication_prescriptions_filter" class="form-control" oninput="this.value = this.value.toUpperCase()">
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="IdMedicationActivePrinciples_fields" class="form-group">
            ...
            <select id="IdMedicationActivePrinciples" name="IdMedicationActivePrinciples" class="form-control @error('IdMedicationActivePrinciples') is-invalid @enderror" url-query="{{ route('users_diseases.query.json', ['IdUsers' => $IdUsers]) }}">
                <option value="">...</option>
            </select>
        </div>              
    </div>
...
<div class="row hide text-allergies">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div id="text_fields" class="form-group">
            ...
            <textarea class="form-control @error('text') is-invalid @enderror" id="text" name="text" rows="3" required>{{old('text') ?? $users_diseases->text ?? ""}}</textarea>
