    ...
    <div class="card-body">
        <div class="row flex-between-center">
            <div class="col-sm-auto mb-2 mb-sm-0">
                <h6 class="mb-0">{{ $exams['count'] }} de {{ $exams['data']->total() }} registros</h6>
            </div>
            <div class="col-sm-auto">
                <div class="row gx-2 align-items-center">
                    <div class="col-auto">
                        <button class="btn btn-falcon-default btn-sm me-2" role="button">Exames</button>
                    </div>
                </div>
            </div>
        </div>
...
<div class="card mb-3" id="customersTable" data-list=''>
    ...
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Exames</h5>
            </div>
    ...
    <div class="accordion" id="accordionExample">
        <div class="accordion-item">
            <div class="accordion-collapse collapse {{ app('request')->input('exams') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">

                    <form id="formFiltro" action="{{ route('exams') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdExams_campo" class="form-group">
                                    <label for="IdExams" id="label_IdExams">Código:</label>
                                    <input type="number" min="1" id="IdExams" name="IdExams" class="form-control form-control-sm" value="{{ app('request')->input('IdExams') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="exams" class="form-control form-control-sm" value="foo"/>
                        <button class="btn btn-outline-primary me-1 mb-1 mt-2 btn-sm" type="submit">FILTRAR</button>
                        <a href="{{ route('exams') }}"><button class="btn btn-outline-primary me-1 mb-1 mt-2 btn-sm" type="button">LIMPAR FILTROS</button></a>
    ...
    <div class="card-body p-0">
        <div class="table-responsive scrollbar">
            <table class="table table-sm table-striped fs--1 border mb-0 overflow-hidden">
                ...
                @if(!empty($exams['data']->total()) AND ($exams['data']->total() > 0))
                    ...
                    <tbody class="list list-table" id="table-customers-body">
                        ...
                        @foreach($exams['data'] as $val)
                            <tr class="btn-reveal-trigger" id="{{$val->IdExams}}-table">
                                    ...
                                    <div class="dropdown font-sans-serif position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-2">
                                            <div class="bg-white py-2">
                                                <!-- edit -->
                                                <a class="dropdown-item fw-bold" href="{{route('exams.form', ['IdExams' => base64_encode($val->IdExams)])}}"><span class="fas fa-edit me-1"></span><span> Editar</span></a>

                                                <!-- delete -->
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item fw-bold" href="{{route('exams.form.delete', ['IdExams' => base64_encode($val->IdExams)])}}" data-id="{{ $val->IdExams }}" action="delete"><span class="fas fa-trash-alt me-1"></span><span> Deletar</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
    ...
    <!-- paginations -- start -->
    {{ $exams['data']->appends(app('request')->all())->links() }}
