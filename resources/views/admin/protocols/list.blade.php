                ...
                <div class="row flex-between-center">
                    <div class="col-sm-auto mb-2 mb-sm-0">
                        <div class="btn-group btn-group-sm" role="group" aria-label="...">
                            <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('protocols.form') }}"><span class="fas fa-plus"></span></button>
                            ...
                            <button class="btn btn-primary btn-sm collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('protocols.form') }}"><span class="fas fa-times"></span></button>
                        </div>
                    </div>
        ...
        <div class="accordion-item">
            <div class="accordion-collapse collapse {{ app('request')->input('protocols') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('protocols') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdProtocols_campo" class="form-group">
                                    <label for="IdProtocols" id="label_IdProtocols">Código:</label>
                                    <input type="number" min="1" id="IdProtocols" name="IdProtocols" class="form-control form-control-sm" value="{{ app('request')->input('IdProtocols') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="protocols" class="form-control form-control-sm" value="foo"/>
                        <button class="btn btn-outline-primary me-1 mb-1 mt-2 btn-sm" type="submit">FILTRAR</button>
                        <a href="{{ route('protocols') }}"><button class="btn btn-outline-primary me-1 mb-1 mt-2 btn-sm" type="button">LIMPAR FILTROS</button></a>
                    </form>
                </div>
            </div>
        </div>
                    ...
                    <tbody class="list list-table" id="table-customers-body">
                        ...
                        @foreach($protocols as $val)
                            <tr class="btn-reveal-trigger" id="{{$val->IdProtocols}}-table">
                                ...
                                <td class="border phone text-1000 white-space-nowrap py-2 text-end" width="5%">
                                    @if($val->status == "a")
                                    ...
                                    <div class="dropdown font-sans-serif position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-2">
                                            <div class="bg-white py-2">
                                                <!-- edit -->
                                                <a class="dropdown-item fw-bold" href="{{route('protocols.form', ['IdProtocols' => base64_encode($val->IdProtocols)])}}"><span class="fas fa-edit me-1"></span><span> Editar</span></a>

                                                <!-- delete -->
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item fw-bold" href="{{route('protocols.form.delete', ['IdProtocols' => base64_encode($val->IdProtocols)])}}" data-id="{{ $val->IdProtocols }}" action="delete"><span class="fas fa-trash-alt me-1"></span><span> Deletar</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
