            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        <button class="btn btn-primary" type="button" data-redirect="{{ route('medication_active_principles.form') }}"><span class="fas fa-plus"></span></button>
                        ...
                        <button class="btn btn-primary collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('medication_active_principles') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
            ...
            <div class="accordion-collapse collapse {{ app('request')->input('medication_active_principles') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('medication_active_principles') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdMedicationActivePrinciples_campo" class="form-group">
                                    ...
                                    <input type="number" min="1" id="IdMedicationActivePrinciples" name="IdMedicationActivePrinciples" class="form-control" value="{{ app('request')->input('IdMedicationActivePrinciples') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="medication_active_principles" class="form-control" value="foo"/>
