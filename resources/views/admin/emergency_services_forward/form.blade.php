...
<div class="row">
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="IdProceduresForward_fields" class="form-group">
            ...
            <select id="IdProceduresForward" name="IdProceduresForward" class="form-control form-control-sm @error('IdProceduresForward') is-invalid @enderror" url-query="{{ route('procedures.form.json') }}">
...
<div class="row">
    <div class="col-sm-12 col-md-4 col-lg-4 col-xl-4">
        ...
        <div class="input-group mb-2">
            <input type="text" id="title_categories_filter" name="title_categories_filter" class="form-control form-control-sm" oninput="this.value = this.value.toUpperCase()">
        </div>
    </div>
    ...
    <div class="col-sm-12 col-md col-lg col-xl">
        <div id="IdSpecialtyCategories_fields" class="form-group">
            ...
            <select id="IdSpecialtyCategories" name="IdSpecialtyCategories" class="form-control form-control-sm @error('IdSpecialtyCategories') is-invalid @enderror" url-query="{{ route('specialty_categories.json') }}">
...
<div class="row mt-1">
    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
        <div id="note_forward_fields" class="form-group">
            ...
            <textarea class="form-control form-control-sm @error('note_forward') is-invalid @enderror" id="note_forward" name="note_forward" rows="3">{{ $emergency_services_forward->note ?? "" }}</textarea>
