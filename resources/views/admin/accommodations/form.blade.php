...
<div class="mt-3 mb-3">
    <span class="h5 text-800">Acomodação</span>
</div>
                ...
                <div class="row flex-between-center">
                    <div class="col-sm-auto mb-2 mb-sm-0">
                        <div class="btn-group btn-group-sm" role="group" aria-label="...">
                            <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('accommodations') }}"><span class="fas fa-arrow-left"></span></button>
            ...
            <div class="row">
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    <div id="IdAccommodations_fields" class="form-group">
                        ...
                        <input type="text" id="IdAccommodations" name="IdAccommodations" class="form-control form-control-sm" value="@if(!empty($accommodations)){{ $accommodations->IdAccommodations }}@endif" readonly="">
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    <div id="created_at_fields" class="form-group">
                        <label for="created_at" id="label_created_at">Criação:</label>
                        <input type="text" id="created_at" name="created_at" class="form-control form-control-sm" value="@if(!empty($accommodations)){{ date('d-m-Y H:i', strtotime($accommodations->created_at)) }}@endif" maxlength="19" readonly="">
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
                    <div id="updated_at_fields" class="form-group">
                        <label for="updated_at" id="label_updated_at">Última edição:</label>
                        <input type="text" id="updated_at" name="updated_at" class="form-control form-control-sm" value="@if(!empty($accommodations)){{ date('d-m-Y H:i', strtotime($accommodations->updated_at)) }}@endif" maxlength="19" readonly="">
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3 col-xl-3">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12">
                    <div id="title_fields" class="form-group">
                        ...
                        <input type="text" id="title" name="title" class="form-control form-control-sm @error('title') is-invalid @enderror" value="{{old('title') ?? $accommodations->title ?? ""}}" oninput="this.value = this.value.toUpperCase()" required>
