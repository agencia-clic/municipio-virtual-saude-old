...
<!-- actions - start -->
<div class="mt-3 mb-3">
    <span class="h5 text-800">Entradas Medicamentos</span>
            ...
            <div class="row flex-between-center">
                <div class="col-sm-auto mb-2 mb-sm-0">
                    <div class="btn-group btn-group-sm" role="group" aria-label="...">
                        <button class="btn btn-primary btn-sm" type="button" data-redirect="{{ route('medication_entries.form') }}"><span class="fas fa-plus"></span></button>
                        ...
                        <button class="btn btn-primary btn-sm collapsed" type="button" title="Limpar Filtros" data-redirect="{{ route('medication_entries') }}"><span class="fas fa-times"></span></button>
                    </div>
                </div>
            ...
            <div class="accordion-collapse collapse {{ app('request')->input('medication_entries') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('medication_entries') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdMedicationEntries_campo" class="form-group">
                                    <label for="IdMedicationEntries" id="label_IdMedicationEntries">Código:</label>
                                    <input type="number" min="1" id="IdMedicationEntries" name="IdMedicationEntries" class="form-control form-control-sm" value="{{ app('request')->input('IdMedicationEntries') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="medication_entries" class="form-control form-control-sm" value="foo"/>
                                ...
                                <td class="border name text-left py-2">
                                    <div class="d-flex d-flex align-items-center">
                                        <div class="avatar avatar-xl me-2">
                                            <div class="avatar-name rounded-circle" title="código"><span>{{ $val->IdMedicationEntries }}</span></div>
                                        </div>
                                    </div>
                                </td>
