    ...
    <div class="card-body">
        <div class="row flex-between-center">
            <div class="col-sm-auto mb-2 mb-sm-0">
                <h6 class="mb-0">{{ $topics['count'] }} de {{ $topics['data']->total() }} registros</h6>
            </div>
...
<div class="card mb-3" id="customersTable" data-list=''>
    ...
    <div class="card-header">
        <div class="row flex-between-center">
            <div class="col-4 col-sm-auto d-flex align-items-center pe-0">
                <h5 class="fs-0 mb-0 text-nowrap py-2 py-xl-0">Tópicos</h5>
            </div>
            <div class="col-8 col-sm-auto text-end ps-2">
                <div id="table-customers-replace-element">
                    <a href="{{ route('topics.form') }}">
    ...
    <div class="accordion" id="accordionExample">
        <div class="accordion-item">
            <div class="accordion-collapse collapse {{ app('request')->input('topics') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">

                    <form id="formFiltro" action="{{ route('topics') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdTopics_campo" class="form-group">
                                    <label for="IdTopics" id="label_IdTopics">Código:</label>
                                    <input type="number" min="1" id="IdTopics" name="IdTopics" class="form-control form-control-sm" value="{{ app('request')->input('IdTopics') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="topics" class="form-control form-control-sm" value="foo"/>
                        <button class="btn btn-outline-primary me-1 mb-1 mt-2 btn-sm" type="submit">FILTRAR</button>
                        <a href="{{ route('topics') }}"><button class="btn btn-outline-primary me-1 mb-1 mt-2 btn-sm" type="button">LIMPAR FILTROS</button></a>
    ...
    <div class="card-body p-0">
        <div class="table-responsive scrollbar">
            <table class="table table-sm table-striped fs--1 border mb-0 overflow-hidden">
                ...
                @if(!empty($topics['data']->total()) AND ($topics['data']->total() > 0))
                    ...
                    <tbody class="list list-table" id="table-customers-body">
                        ...
                        @foreach($topics['data'] as $val)
                            <tr class="btn-reveal-trigger" id="{{$val->IdTopics}}-table">
                                    ...
                                    <div class="dropdown font-sans-serif position-static">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end border py-0" aria-labelledby="customer-dropdown-2">
                                            <div class="bg-white py-2">
                                                <!-- edit -->
                                                <a class="dropdown-item fw-bold" href="{{route('topics.form', ['IdTopics' => base64_encode($val->IdTopics)])}}"><span class="fas fa-edit me-1"></span><span> Editar</span></a>

                                                <!-- delete -->
                                                <div class="dropdown-divider"></div>
                                                <a class="dropdown-item fw-bold" href="{{route('topics.form.delete', ['IdTopics' => base64_encode($val->IdTopics)])}}" data-id="{{ $val->IdTopics }}" action="delete"><span class="fas fa-trash-alt me-1"></span><span> Deletar</span></a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
    ...
    <!-- paginations -- start -->
    {{ $topics['data']->appends(app('request')->all())->links() }}
