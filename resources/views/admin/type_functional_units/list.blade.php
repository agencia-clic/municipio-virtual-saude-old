            ...
            <div class="accordion-collapse collapse {{ app('request')->input('type_functional_units') ? "show" : ""}}" id="collapse2" aria-labelledby="heading2" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    ...
                    <form id="formFiltro" action="{{ route('type_functional_units') }}" method="get" enctype="multipart/form-data">
                        <div class="row">			
                            <div class="col-sm-6 col-md-4 col-lg-4 col-xl-4">
                                <div id="IdTypeFunctionalUnits_campo" class="form-group">
                                    ...
                                    <input type="number" min="1" id="IdTypeFunctionalUnits" name="IdTypeFunctionalUnits" class="form-control" value="{{ app('request')->input('IdTypeFunctionalUnits') }}" maxlength="11" autocomplete="off" />
                                </div>
                            </div>
                        ...
                        <input type="hidden" name="type_functional_units" class="form-control" value="foo"/>
