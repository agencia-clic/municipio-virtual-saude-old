    ...
    <div class="card-body bg-light">
        <div class="row">
            ...
            <div class="list-group-item list-group-item-action">
                <div class="row mt-1">
                    <div class="col-sm-12 col-md-4 col-lg-4 no-margin" style="margin-bottom: 10px; margin-top: 5px; font-size:14px;">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4 no-margin mt-1" style="margin-bottom: 10px; margin-top: 5px; font-size:14px;">
