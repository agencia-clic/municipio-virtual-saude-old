...
use App\Models\ProtocolsMedication;
...
class ProtocolsMedicationController extends Controller
{
    ...
    public function __construct()
    {
        ...
        $this->protocols_medication = new ProtocolsMedication();
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(Request $request, $IdProtocols, $IdProtocolsMedication = null)
    {
        //select from units
        ...
        $protocols_medication = $this->protocols_medication->list_current(base64_decode($IdProtocolsMedication));
    ...
    {
        $protocols_medication = ProtocolsMedication::find(base64_decode($id));
        $data = $request->all();
    ...
    {
        ProtocolsMedication::find(base64_decode($id))->delete();
    }
